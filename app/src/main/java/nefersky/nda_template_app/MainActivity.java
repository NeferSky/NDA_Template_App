package nefersky.nda_template_app;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            ...
            Toast.makeText(getApplicationContext(), "Вы выбрали галерею", Toast.LENGTH_SHORT).show();
            fragmentClass = SecondFragment.class;
        } else if (id == R.id.nav_slideshow) {
            Toast.makeText(getApplicationContext(), "Вы выбрали слайд-шоу", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(getApplicationContext(), "Вы выбрали отправку", Toast.LENGTH_SHORT).show();
